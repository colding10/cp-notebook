...
struct Endpoint {
    ll x;
    ll type; // 0 for starting, 1 for ending
    ll constraint;
    ll id; // the segment to which it belonged

    Endpoint(ll a, ll b, ll c, ll d) {
        x = a;
        type = b;
        constraint = c;
        id = d;
