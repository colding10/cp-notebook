...
public:
    ...
    multiply_brute_force(std::vector<int> const &a, std::vector<int> const &b) {
    ...
    static std::vector<long long> multiply(std::vector<int> const &a,
...
public:
    ...
    bool operator==(BigInteger const &o) const {
        return compare(o) == 0;
    }
    bool operator!=(BigInteger const &o) const {
        return compare(o) != 0;
